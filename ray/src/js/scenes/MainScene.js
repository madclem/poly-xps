...
export default class MainScene
{
	...
	findIntersection(pt1, pt2)
	{
		...
		// line equation
		// r(t) = < pt1[0], pt1[1], pt1[2] > + t <pt2[0], pt2[1], pt2[2]>
		// 1*) r(t) = pt1[0] + t * pt2[0] , t * pt2[1] + pt1[1] , t * pt2[2] + pt1[2];
		...
		let newx = t * pt1[0] + pt2[0];
		let newy = t * pt1[1] + pt2[1];
		let newz = t * pt1[2] + pt2[2];
